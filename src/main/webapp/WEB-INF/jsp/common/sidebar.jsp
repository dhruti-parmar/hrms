	...
	<a href="/index">
		<div class="d-flex align-items-center justify-content-center">
			<h2 class="text-center">
				<img src="${pageContext.request.contextPath}/admin/assets/images/logo.png" alt="logo" class="mb-2"> TalentWave
			</h2>
		</div>
	</a>
  </div>
  <nav class="sidebar-nav">
	<ul>
	  ...
	  <sec:authorize access="!hasRole('ADMIN')">
		...
		<li class="nav-item" id="nav-awards">
			<a href="/employee/awards">
			  <span class="icon">
				<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
				  <path
					d="M8.74999 18.3333C12.2376 18.3333 15.1364 15.8128 15.7244 12.4941C15.8448 11.8143 15.2737 11.25 14.5833 11.25H9.99999C9.30966 11.25 8.74999 10.6903 8.74999 10V5.41666C8.74999 4.7263 8.18563 4.15512 7.50586 4.27556C4.18711 4.86357 1.66666 7.76243 1.66666 11.25C1.66666 15.162 4.83797 18.3333 8.74999 18.3333Z" />
		...
		<span class="divider"><hr></span>	
		<li class="nav-item" id="nav-helpdesk">
			<a href="/employee/helpdesk">
			  <span class="icon">
				<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
				  <path
					d="M8.74999 18.3333C12.2376 18.3333 15.1364 15.8128 15.7244 12.4941C15.8448 11.8143 15.2737 11.25 14.5833 11.25H9.99999C9.30966 11.25 8.74999 10.6903 8.74999 10V5.41666C8.74999 4.7263 8.18563 4.15512 7.50586 4.27556C4.18711 4.86357 1.66666 7.76243 1.66666 11.25C1.66666 15.162 4.83797 18.3333 8.74999 18.3333Z" />
