	...
	<a href="index.html">
		<div class="d-flex align-items-center justify-content-center">
			<h2 class="text-center">
				<img src="admin/assets/images/logo.png" alt="logo" class="mb-2"> TalentWave
			</h2>
		</div>
	</a>
  </div>
	...
	<ul>
	  ...
	  <li class="nav-item nav-item-has-children">
		...
		<ul id="ddmenu_2" class="collapse dropdown-nav">
		  ...
		  <li>
			<a href="javascript:void(0);"> Employee leaves </a>
		  </li>
		  <li>
	  ...
	  <li class="nav-item nav-item-has-children">
		...
		<ul id="ddmenu_3" class="collapse dropdown-nav">
		  <li>
			<a href="javascript:void(0);" class="active"> Pay List </a>
		  </li>
		  <li>
	  ...
	  <li class="nav-item nav-item-has-children">
		...
		<ul id="ddmenu_4" class="collapse dropdown-nav">
		  <li>
			<a href="javascript:void(0);"> Job Dashboard </a>
		  </li>
		  <li>
			<a href="javascript:void(0);"> Ai Post Create</a>
		  </li>
		  <li>
		  ...
		  <li>
			<a href="javascript:void(0);"> Resumes </a>
		  </li>
		</ul>
	  </li>
	  ...
	  <li class="nav-item nav-item-has-children">
		...
		<ul id="ddmenu_5" class="collapse dropdown-nav">
		  <li>
			<a href="javascript:void(0);"> Team Report </a>
		  </li>
		  <li>
			<a href="javascript:void(0);"> Leave Report </a>
		  </li>
		  <li>
			<a href="javascript:void(0);"> Payroll Report </a>
		  </li>
		  <li>
			<a href="javascript:void(0);"> Contact Report </a>
		  </li>
		  <li>
			<a href="javascript:void(0);"> Email Report </a>
		  </li>
		  <li>
			<a href="javascript:void(0);"> WFH Report </a>
		  </li>
		</ul>
	  </li>
	  <li class="nav-item nav-item-has-children">
		...
		>
		  ...
		  <span class="text"> HR Oprations </span>
		</a>
		<ul id="ddmenu_6" class="collapse dropdown-nav">
		  ...
		  <li>
			<a href="javascript:void(0);"> Announcement/Events </a>
		  </li>
		  <li>
			<a href="javascript:void(0);"> Transfers </a>
		  </li>
		  <li>
			<a href="javascript:void(0);"> Resignations </a>
		  </li>
		  <li>
			<a href="javascript:void(0);"> Terminations </a>
		  </li>
		</ul>
	  </li>
	  <li class="nav-item nav-item-has-children">
		...
		<ul id="ddmenu_7" class="collapse dropdown-nav">
		  <li>
			<a href="javascript:void(0);"> HR Tickets </a>
		  </li>
		  <li>
			<a href="javascript:void(0);"> IT Tickets </a>
		  </li>
		  <li>
			<a href="javascript:void(0);"> Account Tickets </a>
		  </li>
		  <li>
